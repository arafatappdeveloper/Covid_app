...
WorldCovidModel worldCovidModelFromJson(String str) => WorldCovidModel.fromJson(json.decode(str));
String worldCovidModelToJson(WorldCovidModel data) => json.encode(data.toJson());
class WorldCovidModel {
  ...
  WorldCovidModel.fromJson(dynamic json) {
...
WorldCovidModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WorldCovidModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
